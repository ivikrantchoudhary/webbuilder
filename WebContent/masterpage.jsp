...
<ul class="site-nav" id="AccessibleNav">
  ...
  <%
    ...
    %>
		...
		<jsp:include page="edititems.jsp"></jsp:include>
    ...
    <div class="wrapper">
      ...
      %>
          ...
          <%
      		...
      		{
      %>    
                <li><a href="contact-us.jsp"><%=pageBean.getContactUs() %></a></li>
        <%
      		}
      		if(pageAllowBean.getfSearch()==1)
      		{
      %>      
                <li><a href="search.jsp"><%=pageBean.getSearch() %></a></li>
        <%
      		}
      		if(pageAllowBean.getfAboutUs()==1)
      		{
      %>      
                <li><a href="about-us.jsp"><%=pageBean.getAboutUs() %></a></li>
        <%
      		}
        %>      
            </ul>

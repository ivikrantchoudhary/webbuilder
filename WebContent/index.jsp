...
<ul class="site-nav" id="AccessibleNav">
    ...
    %>
      <li class="site-nav--active">
        <a href="<%=pageLinkBean.getHome() %>" class="site-nav__link"><%=pageBean.getHome() %></a>
      </li>
    <%
      		}
     ...
     %>
      <li class="site-nav--has-dropdown" aria-haspopup="true">
        <a href="<%=pageLinkBean.getCatalog() %>" class="site-nav__link">
          <%=pageBean.getCatalog() %>
	...
	<%
      ...
      %>
      <li>
        <a href="<%=pageLinkBean.getAboutUs() %>" class="site-nav__link"><%=pageBean.getAboutUs() %></a>
      </li>
    <%
      		}
    %>
  ...
  <%
    ...
    <%
      ...
      %>
    <div>
      <p><a href="<%=pageLinkBean.getAdURL() %>"><img src="<%=adURL%>"></a></p>
    </div>
    <%
      		}
    %>
    ...
    <div class="wrapper">
      ...
      %>    
        ...
        <%
      		...
      		{
      %>      
                <li><a href="<%=pageLinkBean.getfContactUs() %>"><%=pageBean.getSearch() %></a></li>
        <%
      		}
      ...
      %>
          ...
          %>
              ...
              <ul class="inline-list social-icons">
                  ...
                  <li>
                    <a class="icon-fallback-text" href="<%=pageLinkBean.getTwitterLink() %>" title="Code on Twitter">
                  ...
                  <li>
                    <a class="icon-fallback-text" href="<%=pageLinkBean.getFacebookLink() %>" title="Code on Facebook">
      ...
      <%
      		...
      		{
      %>
				<a href="<%=pageLinkBean.getEmail() %>"><%=pageBean.getEmail() %></a><br>
		<%
      		}
    ...
    <input class="btn" name="subscribe" id="subscribe" value="Subscribe" type="submit">
      ...
      %>
        <div class="grid__item large--one-half large--text-left medium-down--text-center">
          <p class="site-footer__links"><%=pageBean.getCopyright() %> </p>
        </div>
        <%
      		}
      ...
      %>
          <div class="grid__item large--one-half large--text-right medium-down--text-center">
            <ul class="inline-list payment-icons">
                ...
                <li>
                  <span class="icon-fallback-text">
                    <a href="<%=pageLinkBean.getPoweredBy() %>" rel="nofollow" target="_blank"><%=pageBean.getPoweredBy() %></a>
                  </span>
                </li>

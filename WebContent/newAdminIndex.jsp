...
<body id="monitoringup-classic-theme-by-shopify" class="template-index">
  ...
  String logolink= Upload_Directory + logoDAO.fetchLogoPics();
     ...
     %>
      ...
      %>
        ...
        <ul class="header-bar__module header-bar__module--list">
              ...
              <li>
      			<a href="MasterPageController.jsp?process=cart&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      			</a>
      		</li>
          ...
          <ul class="header-bar__module header-bar__module--list">
              ...
              <li>
      			<a href="MasterPageController.jsp?process=cart&&value=1" >
        			<span class="icon icon-plus" aria-hidden="true"></span>
      			</a>
      		</li>
	...
	%>
      ...
      %>
          ...
          <ul class="header-bar__module header-bar__module--list">
              ...
              <li>
      			<a href="MasterPageController.jsp?process=login&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      			</a>
      		</li>
          ...
          <ul class="header-bar__module header-bar__module--list">
              ...
              <li>
      			<a href="MasterPageController.jsp?process=login&&value=1" >
        			<span class="icon icon-plus" aria-hidden="true"></span>
      			</a>
      		</li>
      ...
      %>
          ...
          <ul class="header-bar__module header-bar__module--list">
              ...
              <li>
              	&nbsp;&nbsp;&nbsp;
      			<a href="MasterPageController.jsp?process=search&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      			</a>
      		</li>
...
<span class="icon-fallback-text mobile-nav__sublist-contract">
  ...
  <header class="site-header" role="banner">
      	...
      	%>
            ...
            <h1 class="site-header__logo large--left" itemscope="" itemtype="http://schema.org/Organization">
              <a href="index.jsp" itemprop="url">
                <img src="<%=logolink %>" alt="MonitoringUp" itemprop="logo">
              </a>  
            </h1>
    ...
    %>
      <li>
      	<a href="MasterPageController.jsp?process=home&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      			</a>
      </li>
      ...
      <li>
      			<a href="MasterPageController.jsp?process=home&&value=1" >
        			<span class="icon icon-plus" aria-hidden="true"></span>      
				</a>
      </li>
    <%
     ...
     %>
      <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </li>
      <li>
      	<a href="MasterPageController.jsp?process=catalog&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      			</a>
      </li>
      ...
      <li>
      			<a href="MasterPageController.jsp?process=catalog&&value=1" >
        			<span class="icon icon-plus" aria-hidden="true"></span>      
				</a>
      </li>
	...
	<%
      ...
      <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </li>
      <li>
      	<a href="MasterPageController.jsp?process=aboutus&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      			</a>
      </li>
      <li>
      ...
      <li>
      			<a href="MasterPageController.jsp?process=aboutus&&value=1" >
        			<span class="icon icon-plus" aria-hidden="true"></span>      
				</a>
      </li>
    <%
  ...
  <li class="sidebar-sublist">
    <div class="sidebar-sublist__trigger-wrap">
      <a href="nd.jsp" class="sidebar-sublist__has-dropdown ">
        Customize theme
      </a>
      ...
      <li class="sidebar-sublist">
    <div class="sidebar-sublist__trigger-wrap">
      <a href="userdraggable.jsp" class="sidebar-sublist__has-dropdown ">
        View Draggable Theme
      </a>
      ...
      <li class="sidebar-sublist">
    <div class="sidebar-sublist__trigger-wrap">
      <a href="index.jsp" class="sidebar-sublist__has-dropdown ">
        View Basic Theme
      </a>
      ...
      <li class="sidebar-sublist">
    <div class="sidebar-sublist__trigger-wrap">
      <a href="AdminShow.jsp" class="sidebar-sublist__has-dropdown ">
  ...
  <footer class="site-footer small--text-center" role="contentinfo">
    ...
    <div class="wrapper">
      ...
      %>
            ...
            <h4><a href="MasterPageController.jsp?process=quicklinks&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      			</a>
      				<%=pageBean.getQuickLinks() %>
      			<a href="MasterPageController.jsp?process=quicklinks&&value=1" >
        			<span class="icon icon-plus" aria-hidden="true"></span>
      			</a>
      		</h4>
          <%
          ...
          <%
      		...
      		{
      %>    
                <li><a href="MasterPageController.jsp?process=contactus&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      				</a>
      				<a href="contact-us.jsp"><%=pageBean.getContactUs() %></a>
      				<a href="MasterPageController.jsp?process=contactus&&value=1" >
        			<span class="icon icon-plus" aria-hidden="true"></span>
      				</a>
      				</li>
        <%
      ...
      %>      
                <li>
                	...
                	<a href="MasterPageController.jsp?process=search&&value=1" >
        			<span class="icon icon-plus" aria-hidden="true"></span>
      				</a>
                </li>
        <%
      ...
      %>      
                <li>
                	<a href="MasterPageController.jsp?process=faboutus&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      				</a>
                	<a href="about-us.jsp"><%=pageBean.getAboutUs() %></a>
                	<a href="MasterPageController.jsp?process=faboutus&&value=1" >
        			<span class="icon icon-plus" aria-hidden="true"></span>
      				</a>
                </li>
        <%
      ...
      %>
            <h4>
            	<a href="MasterPageController.jsp?process=getconnected&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      			</a>
            		<%=pageBean.getGetConnected() %>
            	<a href="MasterPageController.jsp?process=getconnected&&value=1" >
        			<span class="icon icon-plus" aria-hidden="true"></span>
      			</a>
            </h4>
          <%
          ...
          <%
      	  ...
      	  %>
            <h4>
            	<a href="MasterPageController.jsp?process=fcontactus&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      			</a>
            		<%=pageBean.getfContactUs() %>
            	<a href="MasterPageController.jsp?process=fcontactus&&value=1" >
        			<span class="icon icon-plus" aria-hidden="true"></span>
      			</a>
            </h4>
           <%
           ...
           %>
			...
			%>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="MasterPageController.jsp?process=address&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      			</a>
      			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      			<a href="MasterPageController.jsp?process=address&&value=0" >
          ...
          <%
      	  ...
      	  %>
            <h4>
            	<a href="MasterPageController.jsp?process=newsletter&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      			</a>
            		<%=pageBean.getNewsletter() %>
            	<a href="MasterPageController.jsp?process=newsletter&&value=1" >
        			<span class="icon icon-plus" aria-hidden="true"></span>
      			</a>
            </h4>
          <%
      	  ...
      	  %>
            <p>
            	<a href="MasterPageController.jsp?process=signuppromo&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      			</a>
      			&nbsp;&nbsp;
            		<%=pageBean.getSignupPromo() %>
            	&nbsp;&nbsp;
            	<a href="MasterPageController.jsp?process=signuppromo&&value=1" >
        			<span class="icon icon-plus" aria-hidden="true"></span>
      			</a>
            </p>
          <%
      ...
      %>
        <div class="grid__item large--one-half large--text-left medium-down--text-center">
          ...
          <p class="site-footer__links">
          		<a href="MasterPageController.jsp?process=copyright&&value=0" >
        			<span class="icon icon-minus" aria-hidden="true"></span>
      			</a>
      				<%=pageBean.getCopyright() %>
      			<a href="MasterPageController.jsp?process=copyright&&value=1" >
        			<span class="icon icon-plus" aria-hidden="true"></span>
      			</a> 
      	   </p>
        </div>
       <%
          ...
          <div class="grid__item large--one-half large--text-right medium-down--text-center">
            ...
            <ul class="inline-list payment-icons">
                ...
                <li>
                	<a href="MasterPageController.jsp?process=poweredby&&value=0" >
        				<span class="icon icon-minus" aria-hidden="true"></span>
      				</a>
                  <span class="icon-fallback-text">
                  ...
                  <a href="MasterPageController.jsp?process=poweredby&&value=1" >
        				<span class="icon icon-plus" aria-hidden="true"></span>
      			   </a>
                </li>
